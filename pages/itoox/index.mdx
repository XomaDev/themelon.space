...
title: Itoo X
date: 2023-12-27
description: Itoo X is a framework that creates a virtual App Inventor environment for background execution.
tag: App Inventor
...
Itoo X is a core framework behind the [Itoo extension](https://community.appinventor.mit.edu/t/free-background-tasks-itoo/55125?u=kumaraswamy) that creates a virtual App Inventor environment for background execution.

This page explains discusses the usage of the **Itoo Framework**
...
![690x258](https://forthebadge.com/images/featured/featured-built-with-love.svg)
